      ...
      <div className="container mx-auto px-4">
        <div className="mb-16 text-center text-white">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="mb-4 font-heading text-3xl font-bold tracking-tight sm:text-4xl"
          >
          ...
          >
            From concept to deployment, I use a battle-tested process to ensure code quality and rapid delivery.
          </motion.p>
        </div>
